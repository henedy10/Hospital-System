...
@section('title', 'التقارير الطبية')

@section('content')
    <div class="welcome-section"
        style="margin-bottom: 32px; display: flex; justify-content: space-between; align-items: flex-end;">
        <div>
            <h1 style="font-size: 1.75rem; font-weight: 700; color: var(--text-main); margin-bottom: 8px;">التقارير
                والتحليلات 📊</h1>
            <p style="color: var(--text-muted); font-size: 0.95rem;">تابع أداء العيادة وراجع التقارير الطبية الصادرة.</p>
        </div>
    ...
    <div class="glass-card" style="display: flex; flex-direction: column;">
        <h2 style="font-size: 1.1rem; font-weight: 700; margin-bottom: 24px;">توزيع التشخيصات</h2>
    ...
    <div class="glass-card">
        <div class="chart-header">
            <h2 style="font-size: 1.1rem; font-weight: 700;">أحدث التقارير الصادرة</h2>
            <div class="search-input-wrapper" style="width: 250px;">
                <i class="fas fa-search" style="left: 12px; font-size: 0.8rem;"></i>
                <input type="text" class="form-control" style="padding: 8px 12px 8px 32px; font-size: 0.85rem;" placeholder="بحث في التقارير...">
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="display: flex; gap: 8px;">
                                <a href="{{ route('doctor.reports.show', $report['id']) }}" class="btn-icon" title="عرض التفاصيل"><i class="fas fa-eye"></i></a>
                                <a href="#" class="btn-icon" title="تحميل"><i class="fas fa-download"></i></a>
